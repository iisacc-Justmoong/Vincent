...
The externally signed website release is the single file `Vincent-4.0.1-Windows.msi`. Its embedded Authenticode signature supplies publisher identity and integrity, so users do not need a separate certificate or checksum file to install it.
