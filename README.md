...
- Pan, move, zoom, brush, eraser, shape, fill bucket, and paint-style text tools with the Figma-aligned left toolbar, a current-color swatch that opens the HSL color picker, and brush controls that also set shape stroke width, fill color, text size, and text color
