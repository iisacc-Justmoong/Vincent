...
profile name and canvas endpoint. The versioned canvas snapshot travels
directly between the participating devices only after the recipient accepts or
another user explicitly joins.
