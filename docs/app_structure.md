...
- Supplies cached bitmap thumbnail URLs for hierarchy rows through `iconSource`; transformable objects are rasterized into small PNG thumbnails, and base/raster layer thumbnails refresh when their `DrawingSurfaceItem` reports raster content changes.
