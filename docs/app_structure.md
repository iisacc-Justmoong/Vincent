...
- Uses CMake platform packaging metadata so `resources/Appicon.icns` becomes the macOS bundle icon and `resources/Appicon.ico` becomes the Windows executable icon resource.
