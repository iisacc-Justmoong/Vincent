...
- Uses compact 18px tool buttons with toolbar-frame and button x-axis padding set to half the y-axis padding and reduced auxiliary control sizes so the toolbar reads as a dense application command bar.
