...
void tst_MacOSBuildWorkflowContract::cmakeFixesApplicationVersionAt401()
{
    ...
    QVERIFY(cmakeSource.contains(QStringLiteral("project(Vincent VERSION 4.0.2 LANGUAGES C CXX)")));
    ...
    const qsizetype projectIndex = cmakeSource.indexOf(QStringLiteral("project(Vincent VERSION 4.0.2 LANGUAGES C CXX)"));
