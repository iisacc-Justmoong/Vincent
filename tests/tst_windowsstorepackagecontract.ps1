...
Assert-Throws {
    Assert-StorePackagePolicy -Mode Store -IdentityName "" -Publisher "CN=Store Publisher" -DisplayName "Vincent 4" -PublisherDisplayName "Store Publisher" -PackageVersion "4.0.3.0" -DevelopmentCertificateThumbprint ""
} "Package/Identity/Name"
Assert-Throws {
    Assert-StorePackagePolicy -Mode Store -IdentityName "IISACC.Vincent" -Publisher "" -DisplayName "Vincent 4" -PublisherDisplayName "Store Publisher" -PackageVersion "4.0.3.0" -DevelopmentCertificateThumbprint ""
} "Package/Identity/Publisher"
Assert-Throws {
    Assert-StorePackagePolicy -Mode Store -IdentityName "IISACC.Vincent" -Publisher "CN=Store Publisher" -DisplayName "" -PublisherDisplayName "Store Publisher" -PackageVersion "4.0.3.0" -DevelopmentCertificateThumbprint ""
} "Package/Properties/DisplayName"
Assert-Throws {
    Assert-StorePackagePolicy -Mode Store -IdentityName "IISACC.Vincent" -Publisher "CN=Store Publisher" -DisplayName "Vincent 4" -PublisherDisplayName "" -PackageVersion "4.0.3.0" -DevelopmentCertificateThumbprint ""
} "PublisherDisplayName"
Assert-Throws {
    Assert-StorePackagePolicy -Mode Store -IdentityName "IISACC.Vincent" -Publisher "CN=Store Publisher" -DisplayName "Vincent 4" -PublisherDisplayName "Store Publisher" -PackageVersion "4.0.3.1" -DevelopmentCertificateThumbprint ""
} "fourth version field"
Assert-Throws {
    Assert-StorePackagePolicy -Mode Development -IdentityName "IISACC.Vincent.Development" -Publisher "CN=Vincent Development Local Only" -DisplayName "Vincent Development" -PublisherDisplayName "IISACC Development" -PackageVersion "4.0.3.0" -DevelopmentCertificateThumbprint "1234"
} "40-hex"
Assert-StorePackagePolicy -Mode Store -IdentityName "IISACC.Vincent" -Publisher "CN=Store Publisher" -DisplayName "Vincent 4" -PublisherDisplayName "Store Publisher" -PackageVersion "4.0.3.0" -DevelopmentCertificateThumbprint ""
Assert-StorePackagePolicy -Mode Development -IdentityName "IISACC.Vincent.Development" -Publisher "CN=Vincent Development Local Only" -DisplayName "Vincent Development" -PublisherDisplayName "IISACC Development" -PackageVersion "4.0.3.0" -DevelopmentCertificateThumbprint $thumbprint
...
try {
    ...
    Assert-Condition ($identity.Version -eq "4.0.3.0") "The Store package version changed."
