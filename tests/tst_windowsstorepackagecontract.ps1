...
Assert-Throws {
    Assert-StorePackagePolicy -Mode Store -IdentityName "" -Publisher "CN=Store Publisher" -PublisherDisplayName "Store Publisher" -PackageVersion "4.0.1.0" -DevelopmentCertificateThumbprint ""
} "Package/Identity/Name"
Assert-Throws {
    Assert-StorePackagePolicy -Mode Store -IdentityName "IISACC.Vincent" -Publisher "" -PublisherDisplayName "Store Publisher" -PackageVersion "4.0.1.0" -DevelopmentCertificateThumbprint ""
} "Package/Identity/Publisher"
Assert-Throws {
    Assert-StorePackagePolicy -Mode Store -IdentityName "IISACC.Vincent" -Publisher "CN=Store Publisher" -PublisherDisplayName "" -PackageVersion "4.0.1.0" -DevelopmentCertificateThumbprint ""
} "PublisherDisplayName"
Assert-Throws {
    Assert-StorePackagePolicy -Mode Store -IdentityName "IISACC.Vincent" -Publisher "CN=Store Publisher" -PublisherDisplayName "Store Publisher" -PackageVersion "4.0.1.1" -DevelopmentCertificateThumbprint ""
} "fourth version field"
Assert-Throws {
    Assert-StorePackagePolicy -Mode Development -IdentityName "IISACC.Vincent.Development" -Publisher "CN=Vincent Development Local Only" -PublisherDisplayName "IISACC Development" -PackageVersion "4.0.1.0" -DevelopmentCertificateThumbprint "1234"
} "40-hex"
Assert-StorePackagePolicy -Mode Store -IdentityName "IISACC.Vincent" -Publisher "CN=Store Publisher" -PublisherDisplayName "Store Publisher" -PackageVersion "4.0.1.0" -DevelopmentCertificateThumbprint ""
Assert-StorePackagePolicy -Mode Development -IdentityName "IISACC.Vincent.Development" -Publisher "CN=Vincent Development Local Only" -PublisherDisplayName "IISACC Development" -PackageVersion "4.0.1.0" -DevelopmentCertificateThumbprint $thumbprint
