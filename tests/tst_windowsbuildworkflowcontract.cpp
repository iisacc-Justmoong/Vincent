...
void tst_WindowsBuildWorkflowContract::windowsBuildScriptDefinesRunnablePackageContract()
{
    ...
    QVERIFY(source.contains(QStringLiteral("$Version = \"4.0.2\"")));
...
void tst_WindowsBuildWorkflowContract::buildGuideDocumentsWindowsScript()
{
    ...
    QVERIFY(source.contains(QStringLiteral("dist/Vincent-4.0.2-Windows.zip")));
    QVERIFY(source.contains(QStringLiteral("build/Vincent-4.0.2-Windows.msi")));
    ...
    QVERIFY(source.contains(QStringLiteral("Vincent-4.0.2-Windows-Store-x64.msixupload")));
